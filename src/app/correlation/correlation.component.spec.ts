...
describe('CorrelationComponent', () => {
  ...
  it('Should return r=0.9545 with the dataset Data_Test1', () => {
    const result = correlation.getRXY([130, 650, 99, 150, 128, 302, 95, 945, 368, 961], 
  ...
  it('Should return r²=0.9111 with the dataset Data_Test1', () => {
    const result = correlation.getRR([130, 650, 99, 150, 128, 302, 95, 945, 368, 961], 
                                     [186, 699, 132, 272, 291, 331, 199, 1890, 788, 1601]);
  ...
  it('Should return r=0.9631 with the dataset Data_Test3', () => {
    const result = correlation.getRXY([163, 765, 141, 166, 137, 355, 136, 1206, 433, 1130], 
                                      [186, 699, 132, 272, 291, 331, 199, 1890, 788, 1601]);
    expect(result).toBeCloseTo(0.9631, 2);
  });

  it('Should return r²=0.9276 with the dataset Data_Test3', () => {
    const result = correlation.getRR([163, 765, 141, 166, 137, 355, 136, 1206, 433, 1130], 
                                     [186, 699, 132, 272, 291, 331, 199, 1890, 788, 1601]);
