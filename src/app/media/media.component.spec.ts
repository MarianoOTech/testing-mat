...
describe('MediaComponent', () => {
  ...
  it('should return media = 550.6 for the first input', () => {
    const input = [160, 591, 114, 229, 230, 270, 128, 1657, 624, 1503];
    const expectedMedia = 550.6;
    expect(component.calcularMedia(input)).toEqual(expectedMedia);
  });
  
  it('should return media = 60.32 for the second input', () => {
